  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: <Widget>[
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              CustomFlickSoundToggle(
                                size: iconSize,
                                padding: const EdgeInsets.all(10.0),
                                muteChild: Image.asset(
                                  'assets/logos/mute.png',
                                  height: iconSize + 5,
                                  width: iconSize + 5,
                                  color: Colors.blue,
                                ),
                                unmuteChild: Image.asset(
                                  'assets/logos/volume.png',
                                  height: iconSize + 5,
                                  width: iconSize + 5,
                                  color: Colors.blue,
                                ),
                              ...
                              FlickFullScreenToggle(
                                size: iconSize,
                                padding: const EdgeInsets.all(10.0),
                                enterFullScreenChild: Image.asset(
                                  'assets/logos/ic_fullscreen.png',
                                  height: iconSize - 1,
                                  width: iconSize - 2,
                                  color: Colors.blue,
                                ),
                                exitFullScreenChild: Image.asset(
                                  'assets/logos/ic_fullscreen_exit.png',
                                  height: iconSize - 1,
                                  width: iconSize - 2,
                                  color: Colors.blue,
                                ),
        ...
        if(hideBackButton)
        Positioned(
          height: Constants.headerSize.toDouble(),
          top: 30,
          left: 15,
    ...
    return GestureDetector(
        ...
        onTap: () {
          if (toggleMute != null) {
            ...
            sendBroadcast(Constants.updateVideoMuteReceiver,
                data: controlManager.isMute);
          }
        },
        child: Container(
          padding: padding,
